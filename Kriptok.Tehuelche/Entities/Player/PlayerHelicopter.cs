...
{
    internal class PlayerHelicopter : EntityBase
    {
        ...
        protected override void OnFrame()
        {
            ...
            var terrainHeight = terrain.SampleHeight(Location.XY());
        ...
        internal Vector3F GetShootingDirection()
        {
        ...
        internal Vector3F GetShootingLocation()
        {
            var loc = Location;
            if (UserFirstPersonCamera)
            {
        ...
        public class PlayerHelicopterView : VoxelSpaceShapeViewBase
        {
            ...
            public override void SetOwner(IViewOwner entity)
            {
                ...
                this.heli = (PlayerHelicopter)entity;
            }

            public override bool IsVisible3D(IRenderContext3D context)
            {
                if (heli.UserFirstPersonCamera)
                {
                    return false;
                }
