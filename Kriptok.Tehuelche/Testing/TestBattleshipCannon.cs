...
{
    internal class TestBattleshipCannon
    {
        /// <summary>
        ...
        class InitScene : SceneBase
        {
            ...
            {
                var plane = new GdipMode7Plane(Assembly, "Testing.Assets.GrassTexture.png", true);
                var m7v = h.StartPseudo3D(new GdipMode7Region(h.ScreenRegion.Rectangle, plane));

                var tank = h.Add(m7v, new BattleshipCannonTest());
        ...
        class BattleshipCannonTest : EntityBase<BattleshipCannonView>
        {
            ...
            public BattleshipCannonTest() : base(new BattleshipCannonView())
            {
        ...
        {
            private readonly BattleshipCannonTest owner;
            
            public TestEnemyAim(BattleshipCannonTest owner) : base(new TestEnemyAimView(owner))
            {
                this.owner = owner;
            }
            ...
            private class TestEnemyAimView : GdipShapeView
            {
                ...
                public TestEnemyAimView(BattleshipCannonTest owner) : base(new VertexBase[2]
                {
