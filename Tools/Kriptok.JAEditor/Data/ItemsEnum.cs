...
namespace Kriptok.JAEditor.Data
{
    public enum ItemsEnum
    {
        ...
        Max4             = 0b10000000000,
        Max5             = 0b100000000000,
        IsHelmet         = 0b1000000000000,
        IsFaceItem       = 0b10000000000000,
        IsEarsItem       = 0b100000000000000,
        IsBodyItem       = 0b1000000000000000,
        IsVest           = 0b10000000000000000,
        HasBullets       = 0b100000000000000000,
        MaxBullets6      = 0b1000000000000000000,
        MaxBullets10     = 0b10000000000000000000,
        MaxBullets15     = 0b100000000000000000000,
        MaxBullets20     = 0b1000000000000000000000,
        AllowSilencer    = 0b10000000000000000000000,
        AllowSniperScope = 0b100000000000000000000000,
